  ...
  return Object.entries(dataMap || {})
    .map(([key, data]) => {
      ...
      return {
        ...
        cacheReadCost: data.cacheReadCost || 0,
        cacheCreationCost: data.cacheCreationCost || 0,
        outputCost: data.outputCost || 0,
        reasoningCost: data.reasoningCost || 0,
...
function groupDataByKey(data, keyField) {
  ...
  data.forEach((item) => {
    ...
    if (!groups[gk]) {
      groups[gk] = {
        groupKey: gk,
        summary: { requests: 0, promptTokens: 0, completionTokens: 0, cacheReadTokens: 0, cacheCreationTokens: 0, cacheHitRate: 0, totalTokens: 0, cost: 0, totalCost: 0, inputCost: 0, cacheReadCost: 0, cacheCreationCost: 0, outputCost: 0, reasoningCost: 0, lastUsed: null, pending: 0 },
        items: [],
      };
    }
    ...
    s.cost += item.cost || item.totalCost || 0;
    s.totalCost = s.cost;
    s.inputCost += item.inputCost || 0;
    s.cacheReadCost += item.cacheReadCost || 0;
